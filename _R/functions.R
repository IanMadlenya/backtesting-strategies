#' @title checkBlotterUpdate
#' @description Validate strategy results against portfolio, account objects
#' @author Guy Yollin, 2014
#' @source http://www.r-programming.org/papers
